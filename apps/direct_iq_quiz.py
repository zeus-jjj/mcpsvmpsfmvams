...
async def direct_quiz_results(bot, message, quiz_string):
    try:        
        ...
        if not is_subscribe:
            msg_data = {
                        ...
                        "buttons": [
                            [{"title": "Подписаться", "link": "https://t.me/+m8vly_TVVgZmZjcy"}],
        ...
        # Извлечение iq_score
        select_query = """
        SELECT iq_score FROM quiz_sessions_direct WHERE id = %s
        """
        ...
        for res_data in results:
            if res_data['score'] >= iq_score:
                ...
                "buttons": [
                    ...
                    [{"title": "Наш тг-канал", "link": "https://t.me/+nPxeEl-giXc2MTdi"}]
                    ]
                }
